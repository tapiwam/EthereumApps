 ...
 */
public class TradeV1 extends Contract {
    ...
    protected TradeV1(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    protected TradeV1(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
    ...
    public RemoteCall<TransactionReceipt> updateTranStatus(BigInteger _tranid, String _status, String _user) {
        final Function function = new Function(
                ...
                Arrays.<Type>asList(new Uint256(_tranid),
                new Utf8String(_status),
                new Utf8String(_user)),
    ...
    public RemoteCall<BigInteger> findTranPosition(BigInteger tranid) {
        final Function function = new Function(FUNC_FINDTRANPOSITION,
                Arrays.<Type>asList(new Uint256(tranid)),
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint256>() {}));
        return executeRemoteCallSingleValueReturn(function, BigInteger.class);
    }
    ...
    public RemoteCall<TransactionReceipt> updateTran(BigInteger _tranid, String _status, String _account, String _asset, String _loaction, BigInteger _quantity, BigInteger _amount, String _user) {
        final Function function = new Function(
                ...
                Arrays.<Type>asList(new Uint256(_tranid),
                new Utf8String(_status),
                new Utf8String(_account),
                new Utf8String(_asset),
                new Utf8String(_loaction),
                new Int256(_quantity),
                new Int256(_amount),
                new Utf8String(_user)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    ...
    public List<TradeUpdateEventResponse> getTradeUpdateEvents(TransactionReceipt transactionReceipt) {
        List<EventValuesWithLog> valueList = extractEventParametersWithLog(TRADEUPDATE_EVENT, transactionReceipt);
    ...
    public Observable<TradeUpdateEventResponse> tradeUpdateEventObservable(EthFilter filter) {
        return web3j.ethLogObservable(filter).map(new Func1<Log, TradeUpdateEventResponse>() {
            ...
            public TradeUpdateEventResponse call(Log log) {
                EventValuesWithLog eventValues = extractEventParametersWithLog(TRADEUPDATE_EVENT, log);
                TradeUpdateEventResponse typedResponse = new TradeUpdateEventResponse();
    ...
    public List<TradeStatusUpdateEventResponse> getTradeStatusUpdateEvents(TransactionReceipt transactionReceipt) {
        List<EventValuesWithLog> valueList = extractEventParametersWithLog(TRADESTATUSUPDATE_EVENT, transactionReceipt);
    ...
    public Observable<TradeStatusUpdateEventResponse> tradeStatusUpdateEventObservable(EthFilter filter) {
        return web3j.ethLogObservable(filter).map(new Func1<Log, TradeStatusUpdateEventResponse>() {
            ...
            public TradeStatusUpdateEventResponse call(Log log) {
                EventValuesWithLog eventValues = extractEventParametersWithLog(TRADESTATUSUPDATE_EVENT, log);
                TradeStatusUpdateEventResponse typedResponse = new TradeStatusUpdateEventResponse();
                typedResponse.log = log;
                typedResponse.tranid = (BigInteger) eventValues.getNonIndexedValues().get(0).getValue();
                typedResponse.status = (String) eventValues.getNonIndexedValues().get(1).getValue();
    ...
    public static RemoteCall<TradeV1> deploy(Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(TradeV1.class, web3j, credentials, gasPrice, gasLimit, BINARY, "");
    }

    public static RemoteCall<TradeV1> deploy(Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(TradeV1.class, web3j, transactionManager, gasPrice, gasLimit, BINARY, "");
    }

    public static TradeV1 load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new TradeV1(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    public static TradeV1 load(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new TradeV1(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }
